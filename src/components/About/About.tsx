...
const About = () => {
  return (
    <div className="container">
      ...
      <p className="description">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. 
      ...
      <img className="image" src="/path/to/image.jpg" alt="About" />
    </div>
  );
}
